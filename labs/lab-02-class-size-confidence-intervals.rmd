...
Next week you will learn about the mechanics of control variables, and how they impact our estimate of program impact. We will begin to use information about correlations between variables in the model. We get information about the correlation structure through a correlation table, or in a more visually-appealing format with a **pairs plot** in R. 

![](figures/reading-pairs-plot.png)
...
![](figures/pairs-to-ballentine.png)
