...
**Question 2-a: Show how you determine this value using coefficients from Model 01.**

**Question 2-b: Show how you determine this value using coefficients from Model 02.**
...
m4 <- lm( salary ~ male + female + white + minority - 1  )
...
<div class="row"  align="center">
  ...
  Designed by <a href=https://github.com/lecy target="_blank">Jesse Lecy</a><br>
  Part of <a href=http://ds4ps.org/ms-prog-eval-data-analytics/ target="_blank">Eval & Analytics</a><br>
  Page powered by <a href=http://jekyllrb.com target="_blank">Jekyll</a>
